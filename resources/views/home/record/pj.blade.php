...
<div class="pass">
	<form action="{{url('/record/pjtj')}}" method="post">
	{{ csrf_field() }}
			<div class="message">
			<ul class="expert">
			...
			<p class="content">
   			...
   			疗效：<input type="text" name="liaoxiao" required lay-verify="required" placeholder="请输入疗效分值 满分10分" autocomplete="off" class="layui-input" value=''>    
   			服务：<input type="text" name="fuwu" required lay-verify="required" placeholder="请输入服务分值 满分10分" autocomplete="off" class="layui-input" value=''> 
