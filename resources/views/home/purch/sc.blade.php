	...
	@foreach($good as $goodss)
		<li class="transition">
			...
			<div class="tools">
				...
				<a href="{{ url('/hickey/detail')}}/{{$goodss -> gid}}" title="查看" class="layui-btn layui-btn-warm layui-btn-small" target="_blank">
					<i class="layui-icon">&#xe64c;</i>
				</a>
			</div>
			<img src="{{ url('/updates')}}/{{$goodss -> img}}" alt="产品名称">
			<p class="title">{{$goodss -> hname}}</p>
		</li>
	@endforeach
	</ul>
