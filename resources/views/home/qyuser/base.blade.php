...
<div class="base">
	...
	@endif
		<form class="layui-form" action="{{ url('/home/qyuser/editzl')}}" method="post" ENCTYPE= 'MULTIPART/FORM-DATA'>
 		{{ csrf_field() }}
			<!-- 头像 -->
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="gsname" required  lay-verify="required email" placeholder="邮箱设置" value='{{$user -> gsname}}' class="layui-input">
				</div>
			</div>
			<!-- 地域选择 -->
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="code" required  lay-verify="" placeholder="所属医院" value='{{$user -> code}}' class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="email" required  lay-verify="" placeholder="擅长" value='{{$user -> email}}' class="layui-input">
				</div>
			</div>
			<div class="layui-form-item">
				<div class="layui-input-block">
