            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" action="{{ url('/admin/health/update') }}" method='post'  ENCTYPE= 'MULTIPART/FORM-DATA'>
                            {{ csrf_field() }}
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name='visitnum' value="{{ $data ->visitnum }}" class="form-control" id="inputPassword3"
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name='author' value="{{ $data->author }}" class="form-control" id="inputPassword3"
                                               placeholder="请输入作者姓名">
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
