...
class Tongjicontroller extends Controller
{
    ...
    public function users(Request $request)
    {
      ...
      $data['count'] = DB::table('hkyl_user') 
      -> count();
      $data['count3'] = DB::table('hkyl_user')
      -> where('addtime', '>' ,strtotime("-3 day"))
      -> count();
      $data['count7'] = DB::table('hkyl_user')
      -> where('addtime', '>' ,strtotime("-7 day"))
      -> count();
      $data['count30'] = DB::table('hkyl_user')
      -> where('addtime', '>' ,strtotime("-30 day"))
      -> count();
   

    
    	return view('admin.tongji.users',['data' => $data]);
    }
